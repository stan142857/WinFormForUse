...
{
    SqlConnection con = new SqlConnection("Data Source=DESKTOP-9H2IJLA\\MSSQLDEVELOP17;User ID=mingrisoft;Password=mingrisoft;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
    SqlDataReader sdr;
    public SqlHelper()
    {
        //
